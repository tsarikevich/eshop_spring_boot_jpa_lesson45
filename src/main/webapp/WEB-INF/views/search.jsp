...
<div class="container-fluid">
    <form id="searchLbl" method="post" action="${contextPath}/search">
    ...
    <div>
        <c:forEach items="${quantityProductsPages}" var="pageNumber">
            <a href="${contextPath}/search/${search_request}/${pageNumber}">${pageNumber}</a>
        </c:forEach>
    </div>
</div>
</c:if>
